...
public class ExprParser extends Parser {
    ...
    // $ANTLR start "entry"
    // D:\\practice\\functiondrawer\\etc/Expr.g:30:1: entry : ( expr NEWLINE -> expr | NEWLINE ->);
    public final ExprParser.entry_return entry() throws RecognitionException {
        ...
        try {
            // D:\\practice\\functiondrawer\\etc/Expr.g:30:6: ( expr NEWLINE -> expr | NEWLINE ->)
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // D:\\practice\\functiondrawer\\etc/Expr.g:30:10: expr NEWLINE
                    {
                    ...
                    break;
                case 2 :
                    // D:\\practice\\functiondrawer\\etc/Expr.g:31:10: NEWLINE
                    {
    ...
    // $ANTLR start "expr"
    // D:\\practice\\functiondrawer\\etc/Expr.g:36:1: expr : unaryExpr ( ( '+' | '-' ) unaryExpr )* ;
    public final ExprParser.expr_return expr() throws RecognitionException {
        ...
        try {
            // D:\\practice\\functiondrawer\\etc/Expr.g:36:5: ( unaryExpr ( ( '+' | '-' ) unaryExpr )* )
            // D:\\practice\\functiondrawer\\etc/Expr.g:36:9: unaryExpr ( ( '+' | '-' ) unaryExpr )*
            {
            root_0 = (CommonTree)adaptor.nil();
            ...
            // D:\\practice\\functiondrawer\\etc/Expr.g:36:19: ( ( '+' | '-' ) unaryExpr )*
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // D:\\practice\\functiondrawer\\etc/Expr.g:36:20: ( '+' | '-' ) unaryExpr
            	    {
            	    // D:\\practice\\functiondrawer\\etc/Expr.g:36:20: ( '+' | '-' )
            	    int alt2=2;
            	    ...
            	    switch (alt2) {
            	        case 1 :
            	            // D:\\practice\\functiondrawer\\etc/Expr.g:36:21: '+'
            	            {
            	            ...
            	            break;
            	        case 2 :
            	            // D:\\practice\\functiondrawer\\etc/Expr.g:36:27: '-'
            	            {
    ...
    // D:\\practice\\functiondrawer\\etc/Expr.g:39:1: unaryExpr : ( '+' | '-' )* multExpr ;
    public final ExprParser.unaryExpr_return unaryExpr() throws RecognitionException {
        ...
        try {
            // D:\\practice\\functiondrawer\\etc/Expr.g:39:10: ( ( '+' | '-' )* multExpr )
            // D:\\practice\\functiondrawer\\etc/Expr.g:39:13: ( '+' | '-' )* multExpr
            {
            root_0 = (CommonTree)adaptor.nil();

            // D:\\practice\\functiondrawer\\etc/Expr.g:39:13: ( '+' | '-' )*
            loop4:
            do {
                int alt4=3;
                ...
                switch (alt4) {
            	case 1 :
            	    // D:\\practice\\functiondrawer\\etc/Expr.g:39:14: '+'
            	    {
            	    ...
            	    break;
            	case 2 :
            	    // D:\\practice\\functiondrawer\\etc/Expr.g:39:21: '-'
            	    {
    ...
    // D:\\practice\\functiondrawer\\etc/Expr.g:42:1: multExpr : atom ( ( '*' | '/' ) atom )* ;
    public final ExprParser.multExpr_return multExpr() throws RecognitionException {
        ...
        try {
            // D:\\practice\\functiondrawer\\etc/Expr.g:43:5: ( atom ( ( '*' | '/' ) atom )* )
            // D:\\practice\\functiondrawer\\etc/Expr.g:43:9: atom ( ( '*' | '/' ) atom )*
            {
            root_0 = (CommonTree)adaptor.nil();
            ...
            // D:\\practice\\functiondrawer\\etc/Expr.g:43:14: ( ( '*' | '/' ) atom )*
            loop5:
            do {
                int alt5=2;
                ...
                switch (alt5) {
            	case 1 :
            	    // D:\\practice\\functiondrawer\\etc/Expr.g:43:15: ( '*' | '/' ) atom
            	    {
    ...
    // $ANTLR start "atom"
    // D:\\practice\\functiondrawer\\etc/Expr.g:46:1: atom : ( FLOAT | ID | '(' expr ')' | 'sin' atom | 'cos' atom | 'exp' atom );
    public final ExprParser.atom_return atom() throws RecognitionException {
        ...
        try {
            // D:\\practice\\functiondrawer\\etc/Expr.g:46:5: ( FLOAT | ID | '(' expr ')' | 'sin' atom | 'cos' atom | 'exp' atom )
            int alt6=6;
            switch ( input.LA(1) ) {
            case FLOAT:
                {
            ...
            switch (alt6) {
                case 1 :
                    // D:\\practice\\functiondrawer\\etc/Expr.g:46:9: FLOAT
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // D:\\practice\\functiondrawer\\etc/Expr.g:47:9: ID
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // D:\\practice\\functiondrawer\\etc/Expr.g:48:9: '(' expr ')'
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 4 :
                    // D:\\practice\\functiondrawer\\etc/Expr.g:49:9: 'sin' atom
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 5 :
                    // D:\\practice\\functiondrawer\\etc/Expr.g:50:9: 'cos' atom
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 6 :
                    // D:\\practice\\functiondrawer\\etc/Expr.g:51:9: 'exp' atom
                    {
                    root_0 = (CommonTree)adaptor.nil();
